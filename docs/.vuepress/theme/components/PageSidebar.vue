  ...
  <aside class="page-sidebar">
    ...
    <div class="page-side-toolbar">
        ...
        <div class="toc-container">
          <div class="pos-box">
            ...
            <div class="scroll-box" style="text-align:center">
              ...
              <img
                v-bind="{ src: 'https://api.qrserver.com/v1/create-qr-code/?data=https://binghe.gitcode.host' + this.$route.fullPath }"
      ...
      <div class="option-box" @click="$emit('toggle-sidebar-force')">
        <img src="/pagesidebar/sidebar.png" width="30px" class="nozoom" />
        <span class="show-txt">左栏</span>
      </div>

      <!-- <div class="option-box" v-on:mouseout="hideToc($event)" v-on:mouseover="showToc($event)">
        <img class="nozoom" src="/pagesidebar/xingqiu.png" width="25px" />
        <span class="show-txt">星球</span>
        <div class="toc-container">
          <div class="pos-box">
            <div class="icon-arrow"></div>
            <div class="scroll-box" style="text-align:center">
              <span style="font-size:0.8rem;font-weight:bold;">实战项目<span style="font-size:8px;color:red;">「算法实战训练营」</span>
              、问题解答、简历指导、技术分享、晋升指导、视频课程</span>
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        <img class="nozoom" src="/pagesidebar/wechat.png" width="25px" />
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        <img class="nozoom" src="/pagesidebar/baiduwangpan.png" width="25px" />
        <span class="show-txt">下资料</span>
        <div class="toc-container">
          <div class="pos-box">
            <div class="icon-arrow"></div>
            <div class="scroll-box" style="text-align:center">
              <span style="font-size:0.8rem;font-weight:bold;">扫描二维码，回复<span style="color:red;">“领取加群资料”</span>下载<span
                  style="color:red;">两门优质视频资源</span></span>
              <img src="/pagesidebar/gongzonghao.jpg" height="180px" style="margin:10px;" />
              <b>公众号:</b> 慕溪code
            </div>
          </div>
        </div>
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        <img class="nozoom" src="/pagesidebar/support.png" width="25px" />
        ...
        <div class="toc-container">
          <div class="pos-box">
            ...
            <div class="scroll-box" style="text-align:center">
              ...
              <img height="180px" src="/pagesidebar/zanshang.jpg" style="margin:5px;" />
      ...
      <div class="option-box" v-if="prev" style="padding-left:2px;text-align:center;" v-bind:title="prev.title">
        <router-link v-if="prev" :to="prev.path">
          <img src="/pagesidebar/pre.png" width="30px" class="nozoom" />
      ...
      <div class="option-box" v-if="next" style="padding-left:2px;text-align:center;" v-bind:title="next.title">
        <router-link v-if="next" :to="next.path">
          <img src="/pagesidebar/next.png" width="30px" class="nozoom" />
